...
class Media(SQLModel, table=True):
    ...
    generation_job_id: int | None = Field(default=None, foreign_key="generationjob.id")
    ...
    generation_job: Optional["GenerationJob"] = Relationship(back_populates="media")
...
class GenerationJob(SQLModel, table=True):
    ...
    media: List["Media"] = Relationship(back_populates="generation_job")
